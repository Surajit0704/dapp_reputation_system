...
export const CONTRACT_ADDRESS =
  "CAWUF2KUORQMH2RQFQLFGGWPC6WXXID3PEGYZPQAHGW7EN5A4Z4L5MBL";
 ...
 * Calls: give_rep(from: Address, to: Address, amount: i128)
 */
 ...
 * Calls: get_rep(address: Address) -> i128
 */
 ...
 * Calls: get_given_rep(address: Address) -> i128
 */
export async function getGivenRep(
  address: string,
  caller?: string
) {
  return readContract(
 ...
 * Calls: get_vote(from: Address, to: Address) -> i128
 */
export async function getVote(
  ...
  return readContract(
    "get_vote",
    [toScValAddress(from), toScValAddress(to)],
    caller
  );
}
